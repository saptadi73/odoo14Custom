...
class MaintenanceEquipment(models.Model):
    ...
    cost_equipo_id = fields.Float('Cost Equipment')
    cost_equipo_total = fields.Float('Cost Equipment Total', compute="_cost_equipo_total", store=True)
    hour_equip = fields.Float('Hour per Equipment')
